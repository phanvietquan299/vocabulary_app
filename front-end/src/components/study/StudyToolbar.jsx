export default function StudyToolbar({
  ...
  return (
    <header className="study-toolbar">
      <div>
        <p className="topic-page-eyebrow mb-2">Topic exam</p>
        <h1 className="study-toolbar-title mb-1">Practice and review</h1>
        <p className="study-toolbar-subtitle mb-0">
          Tu {currentIndex + 1}/{total} • Da danh dau {totalLearned}/{total} • Dang hoc: {learned ? 'Da hoc' : 'Chua hoc'}
        </p>
      </div>
